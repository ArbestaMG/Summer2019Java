...
public class ArrayListMethods {
	    ...
	    // size(): returns the total number of elements in the list ( similar with lenght method in array
	        ...
	        ArrayList<Integer> price =  new ArrayList<>();
	            ...
	            price.remove( 1 );  //[1, 3]
	            System.out.println("============");
	           System.out.println(price.remove(0));// burada ne sildigini yazdi
	         //   System.out.println(price.remove(4));  bu hata verir. out of bond
	           ...
	           System.out.println(price);
	            Integer num1=4;
	            System.out.println(price.remove(num1));// true
	            System.out.println(price);
	            System.out.println("========");
