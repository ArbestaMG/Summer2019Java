...
public class Explanations {
	...
	Polymorphisim: 
	            occures when the super class/interface is reference type, 
	            and object is created from the classes that have IS A relashion with the super class/interface
	        Ex:
